 ...
 */
export type audit_log_entriesModel =
  runtime.Types.Result.DefaultSelection<Prisma.$audit_log_entriesPayload>;
...
export type Audit_log_entriesAggregateArgs<
...
> = {
   ...
   */
  orderBy?:
    | Prisma.audit_log_entriesOrderByWithRelationInput
    | Prisma.audit_log_entriesOrderByWithRelationInput[];
  /**
...
export type GetAudit_log_entriesAggregateType<
  T extends Audit_log_entriesAggregateArgs,
> = {
  [P in keyof T & keyof AggregateAudit_log_entries]: P extends
    | "_count"
    | "count"
    ? T[P] extends true
      ? number
...
export type audit_log_entriesGroupByArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  where?: Prisma.audit_log_entriesWhereInput;
  orderBy?:
    | Prisma.audit_log_entriesOrderByWithAggregationInput
    | Prisma.audit_log_entriesOrderByWithAggregationInput[];
  by:
    | Prisma.Audit_log_entriesScalarFieldEnum[]
    | Prisma.Audit_log_entriesScalarFieldEnum;
...
export type GetAudit_log_entriesGroupByPayload<
  T extends audit_log_entriesGroupByArgs,
> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Audit_log_entriesGroupByOutputType, T["by"]> & {
      [P in keyof T &
        keyof Audit_log_entriesGroupByOutputType]: P extends "_count"
        ? T[P] extends boolean
          ? number
...
export type audit_log_entriesWhereInput = {
  AND?:
    | Prisma.audit_log_entriesWhereInput
    | Prisma.audit_log_entriesWhereInput[];
  ...
  created_at?:
    | Prisma.DateTimeNullableFilter<"audit_log_entries">
    | Date
    | string
    | null;
...
export type audit_log_entriesWhereUniqueInput = Prisma.AtLeast<
  {
    ...
    NOT?:
      ...
      | Prisma.audit_log_entriesWhereInput[];
    instance_id?:
      | Prisma.UuidNullableFilter<"audit_log_entries">
      | string
      | null;
    payload?: Prisma.JsonNullableFilter<"audit_log_entries">;
    created_at?:
...
export type audit_log_entriesScalarWhereWithAggregatesInput = {
  AND?:
    | Prisma.audit_log_entriesScalarWhereWithAggregatesInput
    | Prisma.audit_log_entriesScalarWhereWithAggregatesInput[];
  ...
  NOT?:
    ...
    | Prisma.audit_log_entriesScalarWhereWithAggregatesInput[];
  instance_id?:
    | Prisma.UuidNullableWithAggregatesFilter<"audit_log_entries">
    | string
    | null;
  ...
  created_at?:
    | Prisma.DateTimeNullableWithAggregatesFilter<"audit_log_entries">
    | Date
    | string
    | null;
...
export type audit_log_entriesSelect<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
...
export type audit_log_entriesSelectCreateManyAndReturn<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = runtime.Types.Extensions.GetSelect<
  {
...
export type audit_log_entriesSelectUpdateManyAndReturn<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = runtime.Types.Extensions.GetSelect<
  {
...
export type audit_log_entriesOmit<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
...
export type $audit_log_entriesPayload<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
...
export type audit_log_entriesGetPayload<
  S extends boolean | null | undefined | audit_log_entriesDefaultArgs,
> = runtime.Types.Result.GetResult<Prisma.$audit_log_entriesPayload, S>;

export type audit_log_entriesCountArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = Omit<
  audit_log_entriesFindManyArgs,
  "select" | "include" | "distinct" | "omit"
> & {
  select?: Audit_log_entriesCountAggregateInputType | true;
};

export interface audit_log_entriesDelegate<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
  GlobalOmitOptions = {},
> {
   ...
   * })
   */
  findUnique<T extends audit_log_entriesFindUniqueArgs>(
    args: Prisma.SelectSubset<T, audit_log_entriesFindUniqueArgs<ExtArgs>>,
  ): Prisma.Prisma__audit_log_entriesClient<
    runtime.Types.Result.GetResult<
      Prisma.$audit_log_entriesPayload<ExtArgs>,
      T,
      "findUnique",
      GlobalOmitOptions
    > | null,
   ...
   * })
   */
  findUniqueOrThrow<T extends audit_log_entriesFindUniqueOrThrowArgs>(
    args: Prisma.SelectSubset<
      T,
      audit_log_entriesFindUniqueOrThrowArgs<ExtArgs>
    >,
  ): Prisma.Prisma__audit_log_entriesClient<
    runtime.Types.Result.GetResult<
      Prisma.$audit_log_entriesPayload<ExtArgs>,
   ...
   * })
   */
  findFirst<T extends audit_log_entriesFindFirstArgs>(
    args?: Prisma.SelectSubset<T, audit_log_entriesFindFirstArgs<ExtArgs>>,
  ): Prisma.Prisma__audit_log_entriesClient<
    runtime.Types.Result.GetResult<
      Prisma.$audit_log_entriesPayload<ExtArgs>,
      T,
  ...
  findFirstOrThrow<T extends audit_log_entriesFindFirstOrThrowArgs>(
    args?: Prisma.SelectSubset<
      T,
      audit_log_entriesFindFirstOrThrowArgs<ExtArgs>
    >,
  ): Prisma.Prisma__audit_log_entriesClient<
    runtime.Types.Result.GetResult<
      Prisma.$audit_log_entriesPayload<ExtArgs>,
   ...
   *
   */
  findMany<T extends audit_log_entriesFindManyArgs>(
    args?: Prisma.SelectSubset<T, audit_log_entriesFindManyArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<
    runtime.Types.Result.GetResult<
      Prisma.$audit_log_entriesPayload<ExtArgs>,
      T,
   ...
   *
   */
  create<T extends audit_log_entriesCreateArgs>(
    args: Prisma.SelectSubset<T, audit_log_entriesCreateArgs<ExtArgs>>,
  ): Prisma.Prisma__audit_log_entriesClient<
    runtime.Types.Result.GetResult<
      Prisma.$audit_log_entriesPayload<ExtArgs>,
      T,
   ...
   *
   */
  createMany<T extends audit_log_entriesCreateManyArgs>(
    args?: Prisma.SelectSubset<T, audit_log_entriesCreateManyArgs<ExtArgs>>,
   ...
   *
   */
  createManyAndReturn<T extends audit_log_entriesCreateManyAndReturnArgs>(
    args?: Prisma.SelectSubset<
      T,
      audit_log_entriesCreateManyAndReturnArgs<ExtArgs>
    >,
  ): Prisma.PrismaPromise<
    runtime.Types.Result.GetResult<
      Prisma.$audit_log_entriesPayload<ExtArgs>,
   ...
   *
   */
  delete<T extends audit_log_entriesDeleteArgs>(
    args: Prisma.SelectSubset<T, audit_log_entriesDeleteArgs<ExtArgs>>,
  ): Prisma.Prisma__audit_log_entriesClient<
    runtime.Types.Result.GetResult<
      Prisma.$audit_log_entriesPayload<ExtArgs>,
      T,
   ...
   *
   */
  update<T extends audit_log_entriesUpdateArgs>(
    args: Prisma.SelectSubset<T, audit_log_entriesUpdateArgs<ExtArgs>>,
  ): Prisma.Prisma__audit_log_entriesClient<
    runtime.Types.Result.GetResult<
      Prisma.$audit_log_entriesPayload<ExtArgs>,
      T,
   ...
   *
   */
  deleteMany<T extends audit_log_entriesDeleteManyArgs>(
    args?: Prisma.SelectSubset<T, audit_log_entriesDeleteManyArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<Prisma.BatchPayload>;
   ...
   *
   */
  updateMany<T extends audit_log_entriesUpdateManyArgs>(
    args: Prisma.SelectSubset<T, audit_log_entriesUpdateManyArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<Prisma.BatchPayload>;
   ...
   *
   */
  updateManyAndReturn<T extends audit_log_entriesUpdateManyAndReturnArgs>(
    args: Prisma.SelectSubset<
      T,
      audit_log_entriesUpdateManyAndReturnArgs<ExtArgs>
    >,
  ): Prisma.PrismaPromise<
    runtime.Types.Result.GetResult<
      Prisma.$audit_log_entriesPayload<ExtArgs>,
   ...
   * })
   */
  upsert<T extends audit_log_entriesUpsertArgs>(
    args: Prisma.SelectSubset<T, audit_log_entriesUpsertArgs<ExtArgs>>,
  ): Prisma.Prisma__audit_log_entriesClient<
    runtime.Types.Result.GetResult<
      Prisma.$audit_log_entriesPayload<ExtArgs>,
      T,
    ...
    T extends runtime.Types.Utils.Record<"select", any>
      ? T["select"] extends true
        ...
        : Prisma.GetScalarType<
            T["select"],
            Audit_log_entriesCountAggregateOutputType
          >
      : number
  >;
   ...
   * })
   **/
  aggregate<T extends Audit_log_entriesAggregateArgs>(
    args: Prisma.Subset<T, Audit_log_entriesAggregateArgs>,
  ): Prisma.PrismaPromise<GetAudit_log_entriesAggregateType<T>>;
  ...
  >(
    args: Prisma.SubsetIntersection<
      T,
      audit_log_entriesGroupByArgs,
      OrderByArg
    > &
      InputErrors,
  ): {} extends InputErrors
    ? GetAudit_log_entriesGroupByPayload<T>
 ...
 */
export interface Prisma__audit_log_entriesClient<
  T,
  Null = never,
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
 ...
 */
export type audit_log_entriesFindUniqueArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type audit_log_entriesFindUniqueOrThrowArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type audit_log_entriesFindFirstArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type audit_log_entriesFindFirstOrThrowArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type audit_log_entriesFindManyArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type audit_log_entriesCreateArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data: Prisma.XOR<
    Prisma.audit_log_entriesCreateInput,
    Prisma.audit_log_entriesUncheckedCreateInput
  >;
};
 ...
 */
export type audit_log_entriesCreateManyArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data:
    | Prisma.audit_log_entriesCreateManyInput
    | Prisma.audit_log_entriesCreateManyInput[];
 ...
 */
export type audit_log_entriesCreateManyAndReturnArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type audit_log_entriesUpdateArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data: Prisma.XOR<
    Prisma.audit_log_entriesUpdateInput,
    Prisma.audit_log_entriesUncheckedUpdateInput
  >;
  /**
 ...
 */
export type audit_log_entriesUpdateManyArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data: Prisma.XOR<
    Prisma.audit_log_entriesUpdateManyMutationInput,
    Prisma.audit_log_entriesUncheckedUpdateManyInput
  >;
  /**
 ...
 */
export type audit_log_entriesUpdateManyAndReturnArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type audit_log_entriesUpsertArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type audit_log_entriesDeleteArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type audit_log_entriesDeleteManyArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type audit_log_entriesDefaultArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs =
    runtime.Types.Extensions.DefaultArgs,
> = {
  /**
